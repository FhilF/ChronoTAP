...
public class ApproverLeaveOfAbsenceFragment extends Fragment {

    private OnFragmentInteractionListener mListener;

    public ApproverLeaveOfAbsenceFragment() {
    ...
    Button btnSubmit;
    TextView txtType, txtDateFrom, txtDateTo, txtHalfday, txtReason, txtStatus, txtDateSubmitted, txtEmployeeName;
    String fFormId, fLeaveType, fLeaveDateFrom, fLeaveDateTo, fHalfDay, fReason, fFormStatus, fDateSubmitted, fEmployeeName;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_approver_leave_of_absence, container, false);
        ...
        txtType = view.findViewById(R.id.TxtLeaveType);
        txtDateFrom = view.findViewById(R.id.TxtLeaveDateFrom);
        txtDateTo = view.findViewById(R.id.TxtLeaveDateTo);
        txtHalfday = view.findViewById(R.id.TxtLeaveHalfDay);
        txtReason = view.findViewById(R.id.TxtLeaveReason);
        txtStatus = view.findViewById(R.id.TxtFormStatus);
        ...
        fLeaveType = bundle.getString("Type");
        fLeaveDateFrom = bundle.getString("DateFrom");
        fLeaveDateTo = bundle.getString("DateTo");
        fHalfDay = bundle.getString("HalfDay");
        fReason = bundle.getString("Reason");
        fFormStatus = bundle.getString("Status");
        fDateSubmitted = bundle.getString("DateSubmitted");
        txtType.setText(fLeaveType);
        txtDateFrom.setText(fLeaveDateFrom);
        txtDateTo.setText(fLeaveDateTo);
        ...
        if (fHalfDay.equals("1")){
            fHalfDayValue = "Yes";
        }else {
            fHalfDayValue = "No";
        }
        txtHalfday.setText(fHalfDayValue);
        txtReason.setText(fReason);
        txtStatus.setText(fFormStatus);
