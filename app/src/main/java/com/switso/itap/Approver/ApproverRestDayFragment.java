...
public class ApproverRestDayFragment extends Fragment {

    private OnFragmentInteractionListener mListener;

    public ApproverRestDayFragment() {
    ...
    Button btnSubmit;
    String fFormId, fOption, fNewRestDay, fOldRestDay, fReason, fFormStatus, fDateSubmitted,fEmployeeName;
    LinearLayout linAddRestDay, linChangeRestDay, linRemoveRestDay;
    TextView txtOption, txtAddNewRestDay, txtChangeOldRestDay, txtChangeNewRestDay, txtRemoveOldRestDay, txtReason, txtFormStatus, txtDateSubmitted, txtEmployeeName;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_approver_rest_day, container, false);
        ...
        txtOption = view.findViewById(R.id.TxtRestdayOption);
        txtAddNewRestDay = view.findViewById(R.id.TxtRestdayAddNewRestDay);
        txtChangeOldRestDay = view.findViewById(R.id.TxtRestdayChangeOldRestDay);
        txtChangeNewRestDay = view.findViewById(R.id.TxtRestdayChangeNewRestDay);
        txtRemoveOldRestDay = view.findViewById(R.id.TxtRestdayRemoveOldRestDay);
        txtReason = view.findViewById(R.id.TxtRestdayReason);
        ...
        linAddRestDay = view.findViewById(R.id.RestdayOptionAdd);
        linChangeRestDay = view.findViewById(R.id.RestdayOptionChange);
        linRemoveRestDay = view.findViewById(R.id.RestdayOptionRemove);
        Bundle bundle = this.getArguments();
        fFormId = bundle.getString("FormId");
        fEmployeeName = bundle.getString("EmployeeName");
        fOption = bundle.getString("Option");
        fOldRestDay = bundle.getString("OldDate");
        fNewRestDay = bundle.getString("NewDate");
        ...
        if (fOption.equals("1")){
            ...
            linAddRestDay.setVisibility(View.VISIBLE);
            linChangeRestDay.setVisibility(View.GONE);
            linRemoveRestDay.setVisibility(View.GONE);
            txtOption.setText("Add");
            txtAddNewRestDay.setText(fNewRestDay);

        }else if (fOption.equals("2")){

            linChangeRestDay.setVisibility(View.VISIBLE);
            linAddRestDay.setVisibility(View.GONE);
            linRemoveRestDay.setVisibility(View.GONE);
            txtOption.setText("Change");
            txtChangeNewRestDay.setText(fNewRestDay);
            txtChangeOldRestDay.setText(fOldRestDay);

        }else if (fOption.equals("3")){

            linRemoveRestDay.setVisibility(View.VISIBLE);
            linAddRestDay.setVisibility(View.GONE);
            linChangeRestDay.setVisibility(View.GONE);
            txtOption.setText("Remove");
            txtRemoveOldRestDay.setText(fOldRestDay);
