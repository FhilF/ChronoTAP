...
public class ApproverOvertimeFragment extends Fragment {

    private OnFragmentInteractionListener mListener;

    public ApproverOvertimeFragment() {
    ...
    Button btnSubmit;
    TextView txtWorkDate, txtStartDate, txtEndDate, txtStartTime, txtEndTime, txtReason, txtFormStatus, txtDateSubmitted, txtEmployeeName;
    String fFormId, fWorkDate, fStartDate, fEndDate, fStartTime, fEndTime, fReason, fFormStatus, fDateSubmitted, fEmployeeName;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_approver_overtime, container, false);
        ...
        txtWorkDate = view.findViewById(R.id.TxtOvertimeWorkDate);
        txtStartDate = view.findViewById(R.id.TxtOvertimeStartDate);
        txtEndDate = view.findViewById(R.id.TxtOvertimeEndDate);
        txtStartTime = view.findViewById(R.id.TxtOvertimeStartTime);
        txtEndTime = view.findViewById(R.id.TxtOvertimeEndTime);
        txtReason = view.findViewById(R.id.TxtOvertimeReason);
