...
public class ApproverTOILCreditFormFragment extends Fragment {

    private OnFragmentInteractionListener mListener;

    public ApproverTOILCreditFormFragment() {
    ...
    Button btnSubmit;
    TextView txtTOILDate, txtStartTime, txtEndTime, txtReason, txtStatus, txtDateSubmitted, txtEmployeeName;
    String fFormId, fTOILDate, fStartTime, fEndTime, fReason, fFormStatus, fDateSubmitted, fEmployeeName;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_approver_toilcredit_form, container, false);
        ...
        txtTOILDate = view.findViewById(R.id.TxtTOILDate);
        txtStartTime = view.findViewById(R.id.TxtTOILStartTime);
        txtEndTime = view.findViewById(R.id.TxtTOILEndTime);
        txtReason = view.findViewById(R.id.TxtTOILReason);
        ...
        fTOILDate = bundle.getString("TOILDate");
